    ...
    return (
        <>
            ...
            <article className="container mx-auto px-4 py-12 md:py-20 animate-in fade-in duration-700">
                {/* Breadcrumbs */}
                <nav className="mx-auto max-w-4xl mb-12 flex items-center gap-2 text-sm text-gray-500 font-medium tracking-wide">
                    <Link href="/blog" className="hover:text-green-primary transition-colors">BLOG</Link>
                    <span className="text-gray-700">/</span>
                    <span className="text-gray-400 truncate uppercase tracking-widest text-[10px]">{article.title}</span>
                </nav>
                ...
                <div className="mx-auto max-w-4xl space-y-12">
                    <div className="space-y-6 text-center md:text-left">
                        ...
                        <h1 className="text-4xl font-bold font-heading leading-tight tracking-tight text-white sm:text-5xl md:text-6xl lg:text-7xl">
                            {article.title}
                        </h1>

                        <div className="flex flex-col md:flex-row items-center md:items-end justify-between gap-6 pt-4 border-b border-white/5 pb-8">
                            <div className="flex flex-wrap justify-center md:justify-start gap-6">
                                {article.authors?.map((author: any) => (
                                    <div key={author.id} className="flex items-center gap-3">
                                        {author.avatar && (
                                            <div className="relative h-12 w-12 overflow-hidden rounded-full border border-white/10 ring-2 ring-green-primary/20 shadow-xl">
                                                <Image
                                        ...
                                        <div className="text-left">
                                            <p className="text-base font-bold text-white tracking-wide">{author.name}</p>
                            ...
                            <div className="flex items-center gap-4 text-xs font-bold uppercase tracking-widest text-gray-600">
                                <span className="flex items-center gap-1.5 border-r border-white/10 pr-4">
                                    <svg className="w-4 h-4 text-green-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor" suppressHydrationWarning>
                    ...
                    {keyTakeaways.length > 0 && (
                        <div className="bg-gradient-to-br from-green-primary/10 via-white/5 to-transparent border border-green-primary/20 rounded-3xl p-8 md:p-10 relative overflow-hidden group">
                            ...
                            <h3 className="text-green-primary font-bold font-heading text-lg mb-6 flex items-center gap-3">
                            ...
                            <ul className="grid md:grid-cols-1 gap-4">
                                {keyTakeaways.map((item, i) => (
                                    <li key={i} className="flex items-start gap-4 text-gray-300">
                                        <span className="flex-shrink-0 w-6 h-6 rounded-full bg-green-primary/20 flex items-center justify-center text-green-primary text-[10px] font-bold mt-0.5">
                                            {i + 1}
                                        </span>
                    ...
                    {article.authors?.length > 0 && (
                        <div className="mt-24 bg-black-secondary border border-white/5 rounded-[2.5rem] p-10 md:p-14 relative overflow-hidden">
                            ...
                            <div className="flex flex-col md:flex-row items-center gap-10">
                                ...
                                <div className="flex-1 text-center md:text-left">
                                    ...
                                    <h3 className="text-3xl font-bold font-heading text-white mb-4">{article.authors[0].name}</h3>
                                    ...
                                    <div className="mt-8 flex flex-wrap justify-center md:justify-start gap-4">
                                        <Link
                                            href="/blog"
                                            className="px-6 py-2 rounded-full border border-white/10 text-white text-xs font-bold hover:bg-white/5 transition-colors"
                                        >
                                            VER TODOS OS POSTS
                                        </Link>
                                        <Link
                                            ...
                                            className="px-6 py-2 rounded-full bg-green-primary/10 border border-green-primary/20 text-green-primary text-xs font-bold hover:bg-green-primary/20 transition-colors"
                                        >
